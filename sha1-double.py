...
with open('hash_sha1.txt', 'w') as file:
    while True:
        ...
        for i in chars:
                ...
                sha1_hash0_double = calculate_sha1_hash(sha1_hash0)

                sha1_hash1 = calculate_sha1_hash(text1)
                sha1_hash1_double = calculate_sha1_hash(sha1_hash1)

                print(f"{sha1_hash0_double}\n{sha1_hash1_double}\n")

                file.write(f"{sha1_hash0_double}\n{sha1_hash1_double}\n")
        time.sleep(0.8)
